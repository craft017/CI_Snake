...
public class SidePanel extends JPanel {
	 ...
	 */
	public static final Font LARGE_FONT = new Font("Tahoma", Font.BOLD, 20);
	
	/**
	 * The medium font to draw with.
	 */
	public static final Font MEDIUM_FONT = new Font("Tahoma", Font.BOLD, 16);
	...
	public static final int STATISTICS_OFFSET = 150;
	
	public static final int CONTROLS_OFFSET = 320;
	
	public static final int MESSAGE_STRIDE = 30;
	
	public static final int SMALL_OFFSET = 30;
	
	public static final int LARGE_OFFSET = 50;
